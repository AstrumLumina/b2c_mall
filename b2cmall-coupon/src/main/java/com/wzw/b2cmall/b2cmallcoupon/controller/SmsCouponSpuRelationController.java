...
import com.wzw.b2cmall.b2cmallcoupon.service.SmsCouponSpuRelationService;
 ...
 */
@RestController
@RequestMapping("b2cmallcoupon/smscouponspurelation")
public class SmsCouponSpuRelationController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("b2cmallcoupon:smscouponspurelation:list")
    ...
    //@RequiresPermissions("b2cmallcoupon:smscouponspurelation:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("b2cmallcoupon:smscouponspurelation:save")
    ...
    //@RequiresPermissions("b2cmallcoupon:smscouponspurelation:update")
    ...
    //@RequiresPermissions("b2cmallcoupon:smscouponspurelation:delete")
