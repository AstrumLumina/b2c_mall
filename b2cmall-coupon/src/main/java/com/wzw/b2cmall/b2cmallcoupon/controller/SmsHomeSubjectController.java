...
import com.wzw.b2cmall.b2cmallcoupon.entity.SmsHomeSubjectEntity;
import com.wzw.b2cmall.b2cmallcoupon.service.SmsHomeSubjectService;
 ...
 */
@RestController
@RequestMapping("b2cmallcoupon/smshomesubject")
public class SmsHomeSubjectController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("b2cmallcoupon:smshomesubject:list")
    ...
    //@RequiresPermissions("b2cmallcoupon:smshomesubject:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("b2cmallcoupon:smshomesubject:save")
    ...
    //@RequiresPermissions("b2cmallcoupon:smshomesubject:update")
    ...
    //@RequiresPermissions("b2cmallcoupon:smshomesubject:delete")
