 ...
 */
@RestController
@RequestMapping("b2cmallcoupon/smsmemberprice")
public class SmsMemberPriceController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("b2cmallcoupon:smsmemberprice:list")
    ...
    //@RequiresPermissions("b2cmallcoupon:smsmemberprice:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("b2cmallcoupon:smsmemberprice:save")
    ...
    //@RequiresPermissions("b2cmallcoupon:smsmemberprice:update")
    ...
    //@RequiresPermissions("b2cmallcoupon:smsmemberprice:delete")
