...
import com.wzw.b2cmall.b2cmallmember.service.UmsMemberCollectSubjectService;
 ...
 */
@RestController
@RequestMapping("b2cmallmember/umsmembercollectsubject")
public class UmsMemberCollectSubjectController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("b2cmallmember:umsmembercollectsubject:list")
    ...
    //@RequiresPermissions("b2cmallmember:umsmembercollectsubject:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("b2cmallmember:umsmembercollectsubject:save")
    ...
    //@RequiresPermissions("b2cmallmember:umsmembercollectsubject:update")
    ...
    //@RequiresPermissions("b2cmallmember:umsmembercollectsubject:delete")
