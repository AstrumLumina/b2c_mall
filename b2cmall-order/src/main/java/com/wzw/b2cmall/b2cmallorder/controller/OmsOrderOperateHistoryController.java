...
import com.wzw.b2cmall.b2cmallorder.entity.OmsOrderOperateHistoryEntity;
import com.wzw.b2cmall.b2cmallorder.service.OmsOrderOperateHistoryService;
 ...
 */
@RestController
@RequestMapping("b2cmallorder/omsorderoperatehistory")
public class OmsOrderOperateHistoryController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("b2cmallorder:omsorderoperatehistory:list")
    ...
    //@RequiresPermissions("b2cmallorder:omsorderoperatehistory:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("b2cmallorder:omsorderoperatehistory:save")
    ...
    //@RequiresPermissions("b2cmallorder:omsorderoperatehistory:update")
    ...
    //@RequiresPermissions("b2cmallorder:omsorderoperatehistory:delete")
