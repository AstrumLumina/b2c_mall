...
import com.wzw.b2cmall.b2cmallproduct.entity.PmsSkuSaleAttrValueEntity;
import com.wzw.b2cmall.b2cmallproduct.service.PmsSkuSaleAttrValueService;
 ...
 */
@RestController
@RequestMapping("b2cmallproduct/pmsskusaleattrvalue")
public class PmsSkuSaleAttrValueController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("b2cmallproduct:pmsskusaleattrvalue:list")
    ...
    //@RequiresPermissions("b2cmallproduct:pmsskusaleattrvalue:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("b2cmallproduct:pmsskusaleattrvalue:save")
    ...
    //@RequiresPermissions("b2cmallproduct:pmsskusaleattrvalue:update")
    ...
    //@RequiresPermissions("b2cmallproduct:pmsskusaleattrvalue:delete")
