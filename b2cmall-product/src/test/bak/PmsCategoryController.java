 ...
 */
@RestController
@RequestMapping("b2cmallproduct/pmscategory")
public class PmsCategoryController {
    ...
    public R getCategoryTreeByPid(@ApiParam(required = false) @PathVariable(value = "catParentId",required = false) Long catParentId,
